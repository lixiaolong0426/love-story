...
var Rope = function () {
    ...
    _createClass(Rope, [{
        ...
        value: function run(pointer) {
            ...
            try {
                for (var _iterator = this.nodes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next())
            ...
            for (var i = 0; i < 5; i++) {
                ...
                try {
                    for (var _iterator2 = this.constraints[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 =
...
var Scene = function () {
    ...
    _createClass(Scene, [{
        ...
        value: function run() {
            ...
            try {
                for (var _iterator3 = this.nodes[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 =
